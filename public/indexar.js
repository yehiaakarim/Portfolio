...
function formatTime(seconds) {
  ...
  let secs = seconds % 60;
  return `مدة تصفحك للموقع: ${hours.toString().padStart(2, '0')} ساعة , ${minutes.toString().padStart(2, '0')} دقيقة , ${secs.toString().padStart(2, '0')} ثانية`;
}
...
function applyDarkMode() {
  ...
  document.getElementsByClassName("gridone")[0].classList.add("dark-mode");
  document.getElementsByClassName("last")[0].classList.add("dark-mode");
  document.getElementsByClassName("last")[0].classList.add("upperBorder");
  document.getElementsByClassName("btn")[0].classList.add("dark-mode");
  document.getElementsByClassName("firstBtn")[0].classList.add("dark-mode");
  document.getElementsByClassName("mySidebar")[0].classList.add("dark-mode");
  document.getElementsByClassName("btn")[0].classList.add("btnBorder");
  document.getElementsByClassName("border")[0].classList.add("whiteBorder");
  document.getElementsByClassName("border")[1].classList.add("whiteBorder");
  document.getElementsByClassName("underLine")[0].classList.add("underBorder");
  
  for (let i = 0; i < 10; i++) {
    document.getElementsByClassName("num")[i].classList.add("whiteFont");
  }
}
