...
const About = () => {
  ...
  const images = ["/assets/about2.jpg", "/assets/about.jpg", "/assets/about3.jpg"];
  ...
  const content = {
    en: {
      ...
      description: [
        "My name is Yehia Abdelkarim, I am from Cairo, Egypt. I graduated from Faculty of Engineering, Ain Shams University. I am eager to apply my strong problem-solving skills and keen attention to detail to develop engaging, responsive, and user-friendly interfaces. ",
        <>
          I have successfully completed <strong>three</strong> frontend courses
          on Udemy and earned <strong>three</strong> certificates of completion.
          During these courses, I gained deep knowledge of Next.js, React.js,
          Redux, TypeScript, JavaScript, CSS3, Tailwind CSS, HTML, and more. I
          specialise in building mobile-responsive front-end applications that
          seamlessly integrate with APIs and various back-end technologies.
        </>,
      ],
      courseLinks: {
        link1: {
    ...
    ar: {
      ...
      subtitle: "تعرّف عليّ",
      description: [
        "اسمي يحيى عبد الكريم، أنا من القاهرة، مصر. تخرجت من كلية الهندسة بجامعة عين شمس. أنا متحمس لتطبيق مهاراتي القوية في حل المشكلات والاهتمام الدقيق بالتفاصيل لتطوير واجهات جذابة وسريعة الاستجابة وسهلة الاستخدام. ",
        <>
          لقد اتممت دراسة <strong>ثلاثة</strong> كورسات في تطوير الواجهات
          الأمامية للمواقع الألكترونية من موقع يوديمي وحصلت علي{" "}
          <strong>ثلاثة</strong> شهادات لأتمامي هذة الكورسات. خلال هذة الكورسات
          اكتسبت معلومات غزيرة في Next.js, React.js, Redux, TypeScript,
          JavaScript, Tailwind CSS, CSS3, HTML, وغيرهم. أتخصص في بناء تطبيقات
          الواجهة الأمامية المتوافقة مع الهواتف المحمولة والتي تندمج بسلاسة مع
          واجهات برمجة التطبيقات (APIs) وتقنيات الBackend المختلفة.
        </>,
      ],
      courseLinks: {
        link1: {
