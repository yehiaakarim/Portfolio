    ...
    en: {
      ...
      description: [
        ...
        <>
          ...
          Redux, TypeScript, JavaScript, CSS3, Tailwind CSS, HTML, Node.js, Express.js, Nest.js, PostgreSQL, MongoDB and more. I specialise in building mobile-responsive front-end applications that
      ...
      description: [
        ...
        <>لقد أنهيتُ تدريبًا لمدة <strong> ٦ أشهر </strong> في شركة <strong>Potential Soft </strong>
         وأعمل الآن في نفس الشركة كمطوّر واجهات أمامية بدوام كامل.
          ...
          JavaScript, Tailwind CSS, CSS3, HTML, Node.js, Express.js, Nest.js, PostgreSQL, MongoDB وغيرهم. أتخصص في بناء تطبيقات
