...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xpwdjydr", {
        method: "POST",
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          >
            ...
            <button
              ...
              className={`mt-4 px-4 py-2 rounded hover:bg-blue-600 transition ${
      ...
      >
        ...
        <div className="mb-4">
          ...
          >
            ...
            >
              {language === "ar" ? " (جي ميل فقط)" : " (Gmail only)"}
            </span>
          </label>
          <input
            id="email"
